  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        `/api/reservations/booking/${currentUser._id}`,
        formData
      );
  ...
  return (
    <>
      <form
        ...
        className=" overflow-auto px-4 modal h-[60%] w-[70%] left-[15%] top-[20%] absolute md:top-[10%]  md:left-[25%] md:w-[50%]  md:h-[80%]  bg-white z-[10] rounded-sm "
      >
          ...
          <div className="flex flex-col gap-3 mt-5 ">
            ...
            <div className="mt-4 flex justify-between px-5 ">
              <h1 className="text-2xl  ">
                Rs.
                <span className="text-[#d11242] font-semibold ">
                  {Rooms.price}/-
                </span>
              </h1>
              <button className="bg-[#d11242] py-2 px-4 text-white rounded-sm ">
                Book & Pay Later
              </button>
            </div>
          </div>
